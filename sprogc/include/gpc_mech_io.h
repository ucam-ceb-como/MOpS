...
private:
    ...
    static void parseCK_Elements(std::istream &strin,     // File stream.
    ...
    static void parseCK_Species(std::istream &strin,     // File stream.
    ...
    static void parseCK_Reactions(std::istream &strin,     // File stream.
