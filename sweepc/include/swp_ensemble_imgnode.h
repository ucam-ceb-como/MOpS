...
#ifndef SWEEP_ENSEMBLE_IMGNODE_H
#define SWEEP_ENSEMBLE_IMGNODE_H
...
class EnsembleImgNode
{
friend class EnsembleImage;
public:
    // Constructors.
    EnsembleImgNode(void); // Default constructor.

    // Destructors.
    ~EnsembleImgNode(void);
    ...
    void Insert(real radius,Particle *sp);
...
private:
    ...
    EnsembleImgNode *m_parent;         // Parent node.
    EnsembleImgNode *m_left, *m_right; // Left and right child nodes.
