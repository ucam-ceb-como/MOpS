/*
  ...
  File purpose:
    Implementation of the PriPartStats class declared in the
    swp_pripart_stats.h header file.
...
void PriPartStats::Calculate(const Ensemble &e, real scale, real secondary_scale)
{
