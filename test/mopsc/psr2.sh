...
$exe -p -strang -s "a-sweep.xml" -rr "a-mops.inx" > /dev/null 2> /dev/null
CheckErr $?
...
$exe -p -strang -s "b-sweep.xml" -rr "a-mops.inx" > /dev/null 2> /dev/null
CheckErr $?
...
$exe -p -strang -s "c-sweep.xml" -rr "c-mops.inx" > /dev/null 2> /dev/null
CheckErr $?
...
$exe -p -strang -s "a-sweep.xml" -rr "d-mops.inx" > /dev/null 2> /dev/null
CheckErr $?
...
$exe -p -strang -s "e-sweep.xml" -rr "d-mops.inx" > /dev/null 2> /dev/null
CheckErr $?
