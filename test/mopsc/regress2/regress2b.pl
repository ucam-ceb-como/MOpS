...
system("rm regression2b-nuc-coag-acet*");
...
#print "$m0, $m1\n";
if(abs($m0 - 5.2e10) > 2e9) {
  print "Simulated mean M0 was $m0, when 5.2e10 cm^-3 expected\n";
  print "**************************\n";
  print "****** TEST FAILURE ******\n";
  print "**************************\n";
  exit 1;
...
if(abs($m1 - 5.75e-7) > 3e-8) {
  print "Simulated mean M1 was $m1, when 5.75e-7 g cm^-3 expected\n";
  print "**************************\n";
  print "****** TEST FAILURE ******\n";
  print "**************************\n";
  exit 2;
...
system("rm regression2b-nuc-coag-acet*.sav");
system("rm regression2b-nuc-coag-acet*.sen");
system("rm regression2b-nuc-coag-acet*.sim");
system("rm regression2b-nuc-coag-acet*.aux");
