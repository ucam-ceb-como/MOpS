...
# m0 5.50+-0.13e10 g cm^-3
# fv 2.23+-0.06e-11


print "$m0, $m1\n";
if(abs($m0 - 5.49e16) > 6e14) {
  print "Simulated mean M0 was $m0, when 5.49e16 m^-3 expected\n";
  print "**************************\n";
  print "****** TEST FAILURE ******\n";
  print "**************************\n";
  exit 1;
...
if(abs($m1 - 2.22e-11) > 7e-13) {
  print "Simulated mean Fv was $m1, when 2.22e-11 expected\n";
  print "**************************\n";
  print "****** TEST FAILURE ******\n";
  print "**************************\n";
  exit 2;
