/* 
 * File:   swp_transcoag_weighted_PAHs.h
 * Author: nae28
...
#ifndef SWP_TRANSCOAG_WEIGHTED_PAHS_H
#define	SWP_TRANSCOAG_WEIGHTED_PAHS_H
...
class TransitionCoagulationWeightedPAHs : public Coagulation
{
public:
    // Constructors.
	TransitionCoagulationWeightedPAHs(const Sweep::Mechanism &mech); // Default constructor.

	TransitionCoagulationWeightedPAHs(                     // Stream-reading constructor.
        std::istream &in,            //  - Input stream.
        const Sweep::Mechanism &mech //  - Parent mechanism.
        );
    
    //* Virtual destructor
	virtual ~TransitionCoagulationWeightedPAHs() {};
    
	virtual TransitionCoagulationWeightedPAHs* const Clone() const;

    //* Returns the process type for identification during serialisation
    virtual ProcessType ID(void) const {return Transition_Coagulation_Weighted_PAHs_ID;};
...
#endif	/*SWP_TRANSCOAG_WEIGHTED_PAHs_H */
