...
#ifndef SWP_WEIGHTED_EROSIONFRAG_H
#define	SWP_WEIGHTED_EROSIONFRAG_H
...
namespace Processes
{
class WeightedErosionFragmentation : public Fragmentation
{
public:
    //! Ordinary create method
    WeightedErosionFragmentation(const Sweep::Mechanism &mech, const FragWeightRule weight_rule);

    //! Deserialisation
    WeightedErosionFragmentation(                     // Stream-reading constructor.
        std::istream &in,            //  - Input stream.
        const Sweep::Mechanism &mech //  - Parent mechanism.
        );
    
    //* Virtual destructor
    virtual ~WeightedErosionFragmentation() {};
    
    virtual WeightedErosionFragmentation* const Clone() const {return new WeightedErosionFragmentation(*this);};

    //* Returns the process type for identification during serialisation
    virtual ProcessType ID(void) const {return Weighted_Erosion_Fragmentation_ID;};
