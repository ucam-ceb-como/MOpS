/**
  ...
  file that does contain source code.
*/

/**
 * \mainpage The sweep particle simulation library
 ...
 * An early Fortran code for the simulation of soot formation was developed
 * by Michael Balthasar and Jasdeep Singh amongst others.  Robert Patterson
 * wrote a completely new Fortran code with similar functionality, exploiting
 * the analysis Singh and Balthasar had carried out as they developed from
 * scratch.  Patterson named his new code Sweep after the friend of the
 * cartoon character Sooty, since the purpose of the code was to simulate
