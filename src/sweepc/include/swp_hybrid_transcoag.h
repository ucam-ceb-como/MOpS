 ...
 * Sourceforge:    http://sourceforge.net/projects/mopssuite
  ...
  File purpose:
	...
	This process allows the hybrid particle-number and particle model to be used. 
...
#ifndef SWP_HYBRID_TRANSCOAG_H
#define	SWP_HYBRID_TRANSCOAG_H
...
class HybridTransitionCoagulation : public Coagulation
{
public:
    // Constructors.
	HybridTransitionCoagulation(const Sweep::Mechanism &mech); // Default constructor.

	HybridTransitionCoagulation(                     // Stream-reading constructor.
        std::istream &in,            //  - Input stream.
        const Sweep::Mechanism &mech //  - Parent mechanism.
        );
    
    //* Virtual destructor
	virtual ~HybridTransitionCoagulation() {};
    
	virtual HybridTransitionCoagulation* const Clone() const;

    //* Returns the process type for identification during serialisation
    virtual ProcessType ID(void) const {return Hybrid_Transition_Coagulation_ID;};
...
}; //class HybridTransitionCoagulation
