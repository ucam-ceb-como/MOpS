...
#ifndef SWP_WEIGHTED_SYMMETRICFRAG_H
#define	SWP_WEIGHTED_SYMMETRICFRAG_H
...
namespace Processes
{
class WeightedSymmetricFragmentation : public Fragmentation
{
public:
    //! Ordinary create method
    WeightedSymmetricFragmentation(const Sweep::Mechanism &mech, const FragWeightRule weight_rule);

    //! Deserialisation
    WeightedSymmetricFragmentation(                     // Stream-reading constructor.
        std::istream &in,            //  - Input stream.
        const Sweep::Mechanism &mech //  - Parent mechanism.
        );
    
    //* Virtual destructor
    virtual ~WeightedSymmetricFragmentation() {};
    
    virtual WeightedSymmetricFragmentation* const Clone() const {return new WeightedSymmetricFragmentation(*this);};

    //* Returns the process type for identification during serialisation
    virtual ProcessType ID(void) const {return Weighted_Symmetric_Fragmentation_ID;};
...
private:
    ...
    FragWeightRule m_FragWeightRule;
};
