...
#ifndef SWEEP_FRAGMENTATION_H
#define SWEEP_FRAGMENTATION_H
...
public:
    ...
    PropID PropertyID(void) const {return m_pid;}

    void SetPropertyID(PropID pid) {m_pid = pid;}
...
protected:
    ...
    virtual double FragKernel(const Particle &sp, const Cell& sys) const = 0;



    //! Calculate majorant kernel between two particles
    virtual double MajorantKernel(const Particle &sp, const Cell& sys, const MajorantType maj) const = 0;
