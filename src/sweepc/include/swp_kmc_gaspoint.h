...
namespace KMC_ARS {
        ...
        public:
            ...
            static const int    O2 = 5;
            static const int    OH = 6;
            static const int    C2H2 = 7;
            static const int    C2H6 = 8;
            static const int    C6H6 = 9;
            static const int    H2O = 10;
            static const int    CH4 = 11;
            static const int    CO = 12;
            static const int    CO2 = 13;
			static const int    CH3 = 14;
			static const int    C2H4 = 15;
			static const int    C2H3 = 16;
			static const int    C2H = 17;
			static const int    C4H4 = 18;
            static const int    P = 19;
            static const int    None = 20;

            static const int    m_total = 21;
            //! Accessing data
