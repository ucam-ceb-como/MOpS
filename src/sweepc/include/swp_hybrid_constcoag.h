...
#ifndef SWP_HYBRID_CONSTCOAG_H
#define	SWP_HYBRID_CONSTCOAG_H
...
namespace Processes
{
class HybridConstantCoagulation : public Coagulation
{
public:
    // Constructors.
	HybridConstantCoagulation(const Sweep::Mechanism &mech); // Default constructor.

	HybridConstantCoagulation(                     // Stream-reading constructor.
        std::istream &in,            //  - Input stream.
        const Sweep::Mechanism &mech //  - Parent mechanism.
        );
    
    //* Virtual destructor
	virtual ~HybridConstantCoagulation() {};
    
	virtual HybridConstantCoagulation* const Clone() const { return new HybridConstantCoagulation(*this); };

    //* Returns the process type for identification during serialisation
    virtual ProcessType ID(void) const {return Hybrid_Constant_Coagulation_ID;};
