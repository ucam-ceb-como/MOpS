...
public:
    ...
    virtual PAHStructure& initialise(std::string siteList_str, int R6_num, int R5_num_Lone, int R5_num_Embedded);
    //! Create Structure from vector of site types and number of rings
    void createPAH(std::vector<kmcSiteType>& vec, int R6, int R5_Lone, int R5_Embedded);
    ...
    int getRings5EmbeddedCount() const;
