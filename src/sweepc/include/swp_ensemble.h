...
public:
    ...
    int NumOfInceptedPAH(int Model_ID, const int k) const;// return the number of pyrene in current state.
    int IndexOfInceptedPAH(int Model_ID, const int k) const; //move backwards.
