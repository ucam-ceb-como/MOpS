...
const double Sweep::Processes::ErosionFragmentation::s_MajorantFactor = 2.0;
 ...
 *
 */
Sweep::Processes::ErosionFragmentation::ErosionFragmentation(const Sweep::Mechanism &mech)
: Fragmentation(mech)
{
    m_name = "ErosionFragmentation";
}

// Stream-reading constructor.
Sweep::Processes::ErosionFragmentation::ErosionFragmentation(std::istream &in, const Sweep::Mechanism &mech)
: Fragmentation(mech)
{
    m_name = "ErosionFragmentation";
    Deserialize(in, mech);
...
double Sweep::Processes::ErosionFragmentation::Rate(double t, const Cell &sys,
 ...
 */
unsigned int Sweep::Processes::ErosionFragmentation::TermCount() const {return TYPE_COUNT;}
 ...
 */
double Sweep::Processes::ErosionFragmentation::RateTerms(double t, const Cell &sys,
 ...
 */
int ErosionFragmentation::Perform(double t, Sweep::Cell &sys, 
                             const Geometry::LocalGeometry1d& local_geom,
                             unsigned int iterm,
 ...
 */
double Sweep::Processes::ErosionFragmentation::FragKernel(const Particle &sp,
 ...
 */
double Sweep::Processes::ErosionFragmentation::MajorantKernel(const Particle &sp,
                                                                  const Cell& sys,
