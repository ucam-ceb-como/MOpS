...
std::vector<JumpProcess*> KMCMechanism::obtainJumpProcess(){
	...
	JumpProcess* j_M5R_ACR5_ZZ = new M5R_ACR5_ZZ; j_M5R_ACR5_ZZ->initialise();                  //!< 24 - ACR5 migration. //Moved to instant jump process list.
	...
	JumpProcess* j_MR5_R6 = new MR5_R6; j_MR5_R6->initialise();                                 //!< 34 - R5R6 migration. //Moved to instant jump process list.
	...
	//temp.push_back(j_MR5R7_edge);          		//!< 69 - R5R7 healing.
...
// ************************************************************
// ID69 - Embedded 5-member ring migration to ZZ (both sites accesible)
// ************************************************************
