 ...
 *
 */
Sweep::Processes::WeightedErosionFragmentation::WeightedErosionFragmentation(
        const Sweep::Mechanism &mech,
        const FragWeightRule weight_rule)
: Fragmentation(mech)
, m_FragWeightRule(weight_rule)
{
    m_name = "WeightedErosionFragmentation";
}
 ...
 */
Sweep::Processes::WeightedErosionFragmentation::WeightedErosionFragmentation(std::istream &in, const Sweep::Mechanism &mech)
: Fragmentation(mech)
{
    m_name = "WeightedErosionFragmentation";
    Deserialize(in, mech);
    ...
    if(in.good())
        ...
        throw std::runtime_error("Input stream not ready (WeightedErosionFragmentation::WeightedErosionFragmentation)");
}
 ...
 */
double Sweep::Processes::WeightedErosionFragmentation::Rate(double t, const Cell &sys,
 ...
 */
unsigned int Sweep::Processes::WeightedErosionFragmentation::TermCount() const {return TYPE_COUNT;}
 ...
 * @return      Sum of all rate terms for this process
 */
double Sweep::Processes::WeightedErosionFragmentation::RateTerms(double t, const Cell &sys,
 ...
 */
int Sweep::Processes::WeightedErosionFragmentation::Perform(
 ...
 */
double Sweep::Processes::WeightedErosionFragmentation::MajorantKernel(const Particle &sp, const Cell& sys, const MajorantType maj) const
{
 ...
 */
void Sweep::Processes::WeightedErosionFragmentation::Serialize(std::ostream &out) const
{
    ...
    if(out.good())
        ...
        throw std::runtime_error("Output stream not ready (WeightedErosionFragmentation::Serialize).");
}
