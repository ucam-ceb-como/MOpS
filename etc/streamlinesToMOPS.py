...
if(src == "FOAM"):
    foam_case_dir = os.path.abspath("/rds/user/eb656/hpc-work/" +
                                    "Stagnation2/20200619_mym_phi1.0/")
    foam_time = 0.2
    ...
    foam_streamline_file_scalar = os.path.join(foam_streamline_dir,
                                               ...
                                               + "_p_T.csv")
    foam_streamline_file_mech_1 = os.path.join(foam_prostProcess_dir_mech_1,
                                               foam_streamline_basename
    ...
    foam_streamline_file_mech_2 = os.path.join(foam_prostProcess_dir_mech_2,
                                               foam_streamline_basename
                                               + "_X_H_X_C2H6_X_N-C3H7_X_HO2_X_HCCO_X_C3H3_X_C3H6_X_OH_X_C2H2_X_CH3OH_X_C3H4_X_I-C3H7_X_C2H3_X_HE_X_H2_X_CH_X_CH4.csv")
    ...
    mole_fraction_1 = mole_fraction_1.drop(columns=['x'])
    mole_fraction_2 = pd.read_csv(foam_streamline_file_mech_2)
    mole_fraction_2 = mole_fraction_2.drop(columns=['x'])
    ...
    dfInputs['P'] = pressure * 101325.0  # bar to pa
    ...
    dfInputs.to_csv("my_gasphase.csv", index=False)
